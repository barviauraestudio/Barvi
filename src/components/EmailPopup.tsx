...
const BREVO_API_KEY = 'SUA_API_KEY_AQUI' // ← substitui pela nova key
    ...
    <>
      ...
      <div
        style={{
          ...
          backdropFilter: 'blur(48px) saturate(2.4) brightness(0.95)',
          WebkitBackdropFilter: 'blur(48px) saturate(2.4) brightness(0.95)',
          border: '1px solid rgba(201,169,110,0.28)',
          boxShadow: '0 0 0 1px rgba(201,169,110,0.06), 0 32px 80px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,240,210,0.1)',
      ...
      >
        ...
        <div style={{
          position: 'absolute', inset: 0, pointerEvents: 'none',
          backgroundImage: 'linear-gradient(135deg, rgba(255,240,210,0.09) 0%, rgba(201,169,110,0.07) 30%, rgba(139,0,0,0.04) 55%, transparent 75%)',
        }} />
